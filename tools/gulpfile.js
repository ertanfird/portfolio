...
function styles() {
	return src('app/sass/main.sass') // Выбираем источник: "app/sass/main.sass"$ npm install gulp-sass --save-dev
		.pipe(eval(preprocessor)()) // Преобразуем значение переменной "preprocessor" в функцию
		.pipe(concat('main.min.css')) // Конкатенируем в файл app.min.css
